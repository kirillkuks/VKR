...
%%
%%
\newcommand{\Author}{К.С.\,Куксенко} % И.О. Фамилия автора 
\newcommand{\AuthorFull}{Куксенко Кирилл Сергеевич} % Фамилия Имя Отчество автора
\newcommand{\AuthorFullDat}{Куксенко Кириллу Сергеевичу} % Фамилия Имя Отчество автора в дательном падеже (Кому? Студенту...)
\newcommand{\AuthorFullVin}{Куксенко Кирилла Сергеевича} % в винительном падеже (Кого? что?  Програмиста ...)
\newcommand{\AuthorPhone}{+7-963-296-52-77} % номер телефорна автора для оперативной связи  
...
\newcommand{\ConsultantExtra}{А.А.\,Васильев} % И. О. Фамилия дополнительного консультанта 
\newcommand{\ConsultantExtraDegree}{} % 
\newcommand{\ConsultantExtraVin}{А.А.\,Васильева} % И. О. Фамилия дополнительного консультанта в винительном падеже (Кого? что? Руководителя ...)
...
%%
%%
\renewcommand{\thesisTitle}{Реализация эффекта неупорядоченной текстурной анимации}
\newcommand{\thesisDegree}{БАКАЛАВРА}% дипломный проект, дипломная работа, магистерская диссертация %c 2020
\newcommand{\thesisTitleEn}{Non-ordered texture animation effect} %2020
\newcommand{\thesisDeadline}{дд.мм.2022}
\newcommand{\thesisStartDate}{дд.мм.2022}
\newcommand{\thesisYear}{2022}
%%
%%
\newcommand{\group}{5030102/80201} % заменить вместо N номер группы
...
%%
%%
\newcommand{\institute}{Физико-механический институт}%
%%
%%
...
%%
%%
\newcommand{\keywordsRu}{КОМПЬЮТЕРНАЯ ГРАФИКА, ТЕКСТУРНАЯ АНИМАЦИЯ, КАРТЫ СМЕЩЕНИЯ, РАЗРЫВ ТЕКСТУРНЫХ КООРДИНАТ} % ВВЕДИТЕ ключевые слова по-русски
%%
%%
\newcommand{\keywordsEn}{COMPUTER GRAPHICS, TEXTURE ANIMATION, DISPLACEMENT MAP, TEXTURE COORDINATES BREAKING} % ВВЕДИТЕ ключевые слова по-английски
%%
%%
...
\newcommand{\abstractRu}{
	Данная работа посвящена разработке и реализации эффективного алгоритма для создания текстурной анимации.\\
	Весь проект написан на языке программирования C++ с использованием графической библиотеки DirectX11. Для программирования шейдеров использовался язык HLSL.
	Ключевым результатом работы являются получение текстурной анимации в случаи, когда имеется разрыв текстурных координат.
	Результатом проведённой работы является применение разработанного метода к существующим моделям на примере анимации схожей с анимацией их х/ф <<Матрица>>.
} % ВВЕДИТЕ текст аннотации по-русски
%%
%%
\newcommand{\abstractEn}{
	This work is devoted to the development and implementation of an algorithm for creating texture animation.
	The entire project is written in the C++ programming language using the DirectX11 graphics library. The HLSL language is used to program shaders.
	The key result of the work is the appearance of texture in detection when there is a discontinuity in coordinate textures.
	The result of the developed work is the application of the method to the existing effect of demonstrating animation similar to the animation from film <<Matrix>>.
